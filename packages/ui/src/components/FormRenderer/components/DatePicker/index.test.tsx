...
describe('DatePicker', () => {
    ...
    it('should render date picker', async () => {
        ...
        const datePicker = wrapper(element).findDatePicker();
        ...
        expect(handleSubmit).toHaveBeenCalledWith({ date: '2022-01-01' }, expect.any(Object), expect.any(Function));
    });
    ...
    it('should be populated with initial value', async () => {
        ...
        expect(screen.getByPlaceholderText('YYYY/MM/DD')).toHaveValue('2022/01/01');
