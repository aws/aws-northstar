...
describe('Radio', () => {
    ...
    it('should render radio group', async () => {
        ...
        expect(handleSubmit).toHaveBeenCalledWith({ radio: '1' }, expect.any(Object), expect.any(Function));
    });
    ...
    it('should be populated with initial value', async () => {
        ...
        expect(handleSubmit).toHaveBeenCalledWith({ radio: '2' }, expect.any(Object), expect.any(Function));
    });
});
